function [coeff, support] = smrinc_integrator_forceprofile_polyfit(inclim, nrpt, bias, degree)
% SMRINC_INTEGRATOR_FORCEPROFILE_POLYFIT Get force profile
%   coeff = SMRINC_INTEGRATOR_FORCEPROFILE_POLYFIT(inclim, nrpt) returns the force profile
